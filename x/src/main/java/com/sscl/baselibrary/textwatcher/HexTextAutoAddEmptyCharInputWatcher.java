 ...
 * @author alm
 */
public class HexTextAutoAddEmptyCharInputWatcher implements TextWatcher {

    /*--------------------------静态常量--------------------------*/

    private static final String TAG = HexTextAutoAddEmptyCharInputWatcher.class.getSimpleName();
     ...
     */
    public HexTextAutoAddEmptyCharInputWatcher(EditText editText, int maxInput) {
